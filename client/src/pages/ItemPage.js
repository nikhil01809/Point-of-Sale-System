          ...
          >
            ...
            <Form.Item name="category" label="Category">
              <Select>
                ...
                <Select.Option value="MAIN-COURSE(NON_VEG)">Main-course(non-veg)</Select.Option>
                <Select.Option value="MAIN_COURSE(VEG)">Main-course(veg)</Select.Option>
                <Select.Option value="ROTI">Roti</Select.Option>
                <Select.Option value="RICE & NOODLES">Rice & noodles</Select.Option>
